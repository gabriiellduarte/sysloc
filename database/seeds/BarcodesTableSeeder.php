...
class BarcodesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Barcode::create([
            'id'=>1,
            'name'=>'20 Etiquetas por folha - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 4" x 1"\r\nEtiquetas por folha: 20',
            'width'=>3.75,
            'height'=>1,
            'paper_width'=>8.5,
            'paper_height'=>11,
        ...
        Barcode::create([
            'id'=>2,
            'name'=>'30 Etiquetas por folha - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 2.625" x 1"\r\nEtiquetas por folha: 30',
            'width'=>2.625,
            'height'=>1,
            'paper_width'=>8.5,
            'paper_height'=>11,
        ...
        Barcode::create([
            'id'=>3,
            'name'=>'32 Etiquetas por folha - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 2" x 1.25"\r\nEtiquetas por folha: 32',
            'width'=>2,
            'height'=>1.25,
            'paper_width'=>8.5,
            'paper_height'=>11,
        ...
        Barcode::create([
            'id'=>4,
            'name'=>'40 Etiquetas por folha - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 2" x 1"\r\nEtiquetas por folha: 40',
            'width'=>2,
            'height'=>1,
            'paper_width'=>8.5,
            'paper_height'=>11,
        ...
        Barcode::create([
            'id'=>5,
            'name'=>'50 Etiquetas por folha - (8.5" x 11")',
            'description'=>'Sheet Size: 8.5" x 11"\r\nLabel Size: 1.5" x 1"\r\nEtiquetas por folha: 50',
            'width'=>1.5,
            'height'=>1,
            'paper_width'=>8.5,
            'paper_height'=>11,
        ...
        Barcode::create([
            'id'=>6,
            'name'=>'Rolos contínuos - 31.75mm x 25.4mm',
