$(document).ready(function() {
    ...
    var contact_table = $('#contact_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/contatos?tipe=' + $('#contact_type').val(),
        columns: columns,
    ...
    $(document).on('click', '#add_variation', function() {
        ...
        $.ajax({
            method: 'POST',
            url: '/produtos/get_product_variation_row',
...
function get_sub_categories() {
    ...
    $.ajax({
        method: 'POST',
        url: '/produtos/get_sub_categories',
        dataType: 'html',
        data: { cat_id: cat },
        success: function(result) {
            if (result) {
...
function show_product_type_form() {
    ...
    $.ajax({
        method: 'POST',
        url: '/produtos/product_form_part',
        dataType: 'html',
...
function updateProfitLoss(start1 = null, end1 = null, location_id1 = null) {
    if(start1 == null){
