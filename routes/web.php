...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/contatos/ledger', 'ContactController@getLedger');
    Route::get('/contatos/import', 'ContactController@getImportContacts')->name('contatos.import');
    Route::post('/contatos/import', 'ContactController@postImportContacts');
    Route::post('/contatos/check-contact-id', 'ContactController@checkContactId');
    Route::get('/contatos/customers', 'ContactController@getCustomers');
    ...
    Route::post('/produtos/mass-deactivate', 'ProductController@massDeactivate');
    Route::get('/produtos/activate/{id}', 'ProductController@activate');
    Route::get('/produtos/view-product-group-price/{id}', 'ProductController@viewGroupPrice');
    Route::get('/produtos/add-selling-prices/{id}', 'ProductController@addSellingPrices');
    Route::post('/produtos/save-selling-prices', 'ProductController@saveSellingPrices');
    Route::post('/produtos/mass-delete', 'ProductController@massDestroy');
    Route::get('/produtos/view/{id}', 'ProductController@view');
    Route::get('/produtos/list', 'ProductController@getProducts');
    Route::get('/produtos/list-no-variation', 'ProductController@getProductsWithoutVariations');
    Route::post('/produtos/bulk-edit', 'ProductController@bulkEdit');
    Route::post('/produtos/bulk-update', 'ProductController@bulkUpdate');
    Route::post('/produtos/bulk-update-location', 'ProductController@updateProductLocation');
    Route::get('/produtos/get-product-to-edit/{product_id}', 'ProductController@getProductToEdit');
    
    Route::post('/produtos/get_sub_categories', 'ProductController@getSubCategories');
    Route::get('/produtos/get_sub_units', 'ProductController@getSubUnits');
    Route::post('/produtos/product_form_part', 'ProductController@getProductVariationFormPart');
    Route::post('/produtos/get_product_variation_row', 'ProductController@getProductVariationRow');
    Route::post('/produtos/get_variation_template', 'ProductController@getVariationTemplate');
    Route::get('/produtos/get_variation_value_row', 'ProductController@getVariationValueRow');
    Route::post('/produtos/check_product_sku', 'ProductController@checkProductSku');
    Route::get('/produtos/quick_add', 'ProductController@quickAdd');
    Route::post('/produtos/save_quick_product', 'ProductController@saveQuickProduct');
    Route::get('/produtos/get-combo-product-entry-row', 'ProductController@getComboProductEntryRow');
...
Route::middleware(['EcomApi'])->prefix('api/ecom')->group(function () {
    Route::get('produtos/{id?}', 'ProductController@getProductsApi');
